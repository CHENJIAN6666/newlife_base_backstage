<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-row>
       <el-col :span="22">
			...
			<el-form-item label="用户区域ID">
			    <el-input v-model="listQuery.userAreaID" placeholder="用户区域ID"></el-input>
			</el-form-item>


			<el-form-item label="用户ID">
			    <el-input v-model="listQuery.userID" placeholder="用户ID"></el-input>
			</el-form-item>
    ...
    <el-row  style="padding-bottom: 5px;">
      ...
      <el-button size="mini" type="primary" icon="plus" @click="showCreate" v-if="hasPerm('userArea:add')">添加
      </el-button>
      </el-col>
    </el-row>
    </div>
    <el-table size="mini" :data="list" 
      ...
      <el-table-column align="center" label="序号" width="50">
        <template slot-scope="scope">
          <span v-text="getIndex(scope.$index)"> </span>
				 ...
				 <el-table-column align="center" prop="userAreaID" label="用户区域ID" width="100"></el-table-column>
      ...
      <el-table-column align="center" label="操作" width="150" v-if="hasPerm('userArea:update')">
        <template slot-scope="scope">
    ...
    <el-dialog 
      ...
      <el-form size="mini" class="small-space" 
        ...
        label-position="right" label-width="150px" style='margin-left:50px;'>
			 ...
			 <el-col :span="24">
					<el-form-item label="用户区域ID"  prop="userAreaID" >
											<el-input type="text" v-model="tempModel.userAreaID">
											</el-input>
										</el-form-item>	
  ...
  export default {
    data() {
      return {
        ...
        rules: {
			 userAreaID:[
		  { required: true, message: '请填写用户区域ID', trigger: 'blur' }],
    ...
    methods: {
      getList() {
        //查询列表
        //if (!this.hasPerm('userArea:list')) {
        // return
        //}
        this.listLoading = true;
        this.api({
          url: "/userArea/listUserArea",
          method: "get",
      ...
      showUpdate($index) {
        ...
        this.api({
          ...
          method: "post",
          data: {userAreaID:this.list[$index].userAreaID}
        }).then(data => {
          this.tempModel = data;
