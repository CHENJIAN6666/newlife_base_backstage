<template>
  <div class="app-container">
      ...
      <el-row>
       <el-col :span="22">
			...
			<el-form-item label="推文标题">
			    <el-input v-model="listQuery.title" placeholder="推文标题"></el-input>
			</el-form-item>
    ...
    <el-row  style="padding-bottom: 5px;">
      ...
      <el-button size="mini" type="primary" icon="plus" @click="showCreate" v-if="hasPerm('wxPush:add')">添加
      </el-button>
      </el-col>
    </el-row>
    </div>
      ...
      <el-table-column align="center" label="序号" width="50">
        <template slot-scope="scope">
          <span v-text="getIndex(scope.$index)"> </span>
				 ...
				 <el-table-column align="center" prop="image" label="推文图片" width="80">
              <template slot-scope="scope">
                 <img width="40" height="40" v-bind:src="scope.row.image" />
              </template>
         </el-table-column>
			
				 <el-table-column align="center" prop="link" label="推文链接" width="80"></el-table-column>
			
				 <el-table-column align="center" prop="sort" label="推文排序" width="80"></el-table-column>
			

        
      <el-table-column align="center" label="操作" width="150" v-if="hasPerm('wxPush:update')">
        <template slot-scope="scope">
        ...
        label-position="right" label-width="150px" style='margin-left:50px;'>
			 ...
			 <el-col :span="24">
                  ...
                  <newLifeUploadImg :uploadPicData="uploadPicData"
					...
					<el-form-item label="推文排序"  prop="sort" >
											<el-input type="text" v-model="tempModel.sort">
											</el-input>
										</el-form-item>	
...
<script>
  export default {
      ...
      return {
        ...
        rules: {
		  ...
		  { required: true, message: '请填写推文标题', trigger: 'blur' }],
			 ...
			 image:[
		  { required: true, message: '请填写推文图片', trigger: 'blur' }],
		
			 link:[
		  { required: true, message: '请填写推文链接', trigger: 'blur' }],
		
			 sort:[
		  { required: true, message: '请填写推文排序', trigger: 'blur' }],
    ...
    methods: {
      getList() {
        //查询列表
        //if (!this.hasPerm('wxPush:list')) {
        // return
        //}
        this.listLoading = true;
        this.api({
          url: "/wxPush/listWxPush",
          method: "get",
      ...
      showCreate() {
        ...
        //显示新增对话框
					 this.tempModel.wxPushID = "";
					 this.tempModel.title = "";
					 this.tempModel.image = "";
					 this.tempModel.link = "";
					 this.tempModel.sort = 0;
      ...
      showUpdate($index) {
        ...
        this.api({
          url: "/wxPush/getWxPush",
          method: "post",
          data: {wxPushID:this.list[$index].wxPushID}
        }).then(data => {
          this.tempModel = data;
